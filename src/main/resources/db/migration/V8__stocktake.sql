...
-- 재고이벤트에 ADJUST(재고조정) 추가.
ALTER TABLE inventory_txn DROP CONSTRAINT IF EXISTS inventory_txn_txn_type_check;
ALTER TABLE inventory_txn ADD CONSTRAINT inventory_txn_txn_type_check
...
CREATE SEQUENCE seq_stocktake_no START 1;
